export const ReviewData = [
  {
    ...
    about:
      "  Paras Boys Hostel is a soothing place for a focused person as the place is covered with greenery and silence, however the hostel is stounding and the overall architecture is best compared to any other hostel nearby! Its nice living here!",
    proImg: "junaid.jpg",
  },
  ...
  },
  {
    id: 6,
    name: "Riyaj Khan",
    position: "Biotech Student ",
    about:
      " Shalimar Boys Hostel is a gem—close to the university and mosque, safe, and reasonably priced. Perfect for students looking for convenience and affordability. Highly recommended!",
    proImg: "riyaz.jpg",
  },
  {
    id: 7,
    name: "Shamshad Siddiqui",
    position: "BRIT Student",
    about:
      "Nafish, Faiz, and Syed Alam serve the best Muradabadi biryani. It's flavorful, aromatic, and a must-try for biryani lovers. Highly recommended!",
    proImg: "samshad.jpg",
  },
  {
    id: 8,
